...
class UsuarioController{
    ...
    async showId(request: Request, response: Response){
        ...
        if(user){
            ...
            return response.json({userFound: false, error: 'Usuário não encontrado. Verifique o id e tente novamente.'});
        }
    }

    //Listagem de usuario especifico com busca por email
    async showEmail(request: Request, response: Response){       //Listagem de usuario especifico
    ...
    async update(request: Request, response: Response){
        ...
        if(userDB){
            ...
            return response.json({updatedUser: false, error: "Usuário não encontrado"});
        }
    }
